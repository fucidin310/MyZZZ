...
이 프로젝트는 **액션 RPG**장르로 **호요버스**의 **젠레스 존 제로**와 **원신**을 참고하여 제작되었습니다. 언리얼 엔진을 사용하여 제작했습니다.
...
- **전투**<br />
  Gameplay Ability System(GAS)을 활용하여 전투 시스템을 구현했습니다. 플레이블 캐릭터는 일반공격, 스킬, 궁극기, 회피, 회피공격을 가지고, 다양한 버프와 디버프 등을 받을 수 있습니다. 
- **퀘스트**<br />
  특정 몬스터 처치, 특정 NPC와 대화 등 퀘스트 목표와 여러 형태의 보상, 퀘스트 설명 등을 조합하여 다양한 퀘스트를 구현할 수 있습니다.
- **대화**<br />
  CustomGraphAsset을 이용하여 대화 에셋을 구현할 수 있습니다. 대화문과 선택지를 구현할 수 있으며, 선택지에 따라 대화 분기가 나눠질 수 있습니다.
- **인벤토리**<br />
  성유물, 모라(돈), 강화 아이템 등을 저장할 수 있습니다.
- **강화**<br />
- 캐릭터의 레벨, 스킬 레벨을 올릴 수 있습니다. 성유물을 장착하여 캐릭터의 스펙을 올릴 수 있고, 같은 종류의 성유물을 2세트 혹은 4세트를 착용 시 추가 효과를 얻습니다.
- **그 외**<br />
  세이브/로드, 보물 상자, 경치 카메라, 스토리, 카메라와 겹칠 시 반투명화 등
...
- 첫번째, Attribute에는 DefancePower, Multi Handle에는 0.5를 넣어줍니다.
- 두번째, Attribute에는 AttackPower, Multi Handle에는 0.7를 넣어줍니다.
<br />
데미지 배율의 경우에는 스킬에 레벨에 따라 변화하기 때문에 Curve Table을 넣도록 했습니다. 데미지를 계산할 때 스킬의 레벨에 맞는 배율을 가져옵니다.
<br />
<br />
이제 해당 데미지가 발동해야 하는 타이밍에 아래의 함수에 해당되는 구조채를 넘겨 실행하게 합니다.
<br />
<details>
